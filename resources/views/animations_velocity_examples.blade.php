									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class="active"><a href="animations_velocity_examples.html">Advanced examples</a></li>
											</ul>
										</li>
									</ul>
								</li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Velocity</span> - Examples</h4>
						</div>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Properties map</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
							<p class="content-group">Velocity auto-prefixes properties (e.g. transform becomes webkit-transform on WebKit browsers); do not prefix properties yourself. Velocity animates one numeric value per property. Hence, you can pass in: <code>{ padding: 1 }</code> or <code>{ paddingLeft: 1, paddingRight: 1 }</code>. But you cannot pass in <code>{ padding: "1 1 1 1" }</code> because you're providing multiple numeric values.<br>
							...
							<p><a href="#" class="velocity-properties text-semibold"><i class="icon-play3 position-left"></i> Run animation &rarr;</a></p>
							<div class="row">
								<div class="col-md-4">
									<div class="panel">
							...
							<p class="text-semibold">Example code:</p>			            
...
$element.velocity({
	...
	complete: function() {
		$(this).removeAttr('style');
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Chained animation</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							...
							<p class="text-semibold">Example code:</p>
<pre class="language-javascript content-group"><code>// Chained animation
$element.velocity({
	marginLeft: 20
}).velocity({
	marginRight: 20 
	...
	complete: function() {
		$(this).removeAttr('style');
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Effect options</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							...
							<div class="content-group-lg">
								<h6 class="text-semibold">Stagger</h6>
								<p class="content-group">There are three options that work only with UI pack effects, but not with traditional Velocity calls: <code>stagger</code>, <code>drag</code> and <code>backwards</code>. They are passed into a UI pack call as standard Velocity call options.
								...
								<p><a href="#" class="velocity-stagger text-semibold"><i class="icon-play3 position-left"></i> Run stagger example &rarr;</a></p>
								<div class="row">
									<div class="col-md-4">
										<div class="panel panel-callout">
											<div class="panel-heading bg-blue">
...
$element.velocity('transition.slideUpIn', {
	stagger: 500
							...
							<!-- Drag -->
							<div class="content-group-lg">
								<h6 class="text-semibold">Drag</h6>
								<p class="content-group">Set the <code>drag</code> option to <code>true</code> to successively increase the animation duration of each element in a set. The last element will animate with a duration equal to the sequence's original value, whereas the elements before the last will have their duration values gradually approach the original value. The end result is a cross-element easing effect.</p>

								<p><a href="#" class="velocity-drag text-semibold"><i class="icon-play3 position-left"></i> Run drag example &rarr;</a></p>
								<div class="row">
									<div class="col-md-4">
										<div class="panel panel-callout">
											<div class="panel-heading bg-blue">
...
$element.velocity('transition.slideDownOut', {
	...
	backwards: true
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Animation callbacks</h5>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
						...
						<div class="panel-body">
							...
							<!-- Begin callback -->
							<div class="content-group-lg">
								<h6 class="text-semibold">Begin callback</h6>
								<p class="content-group">Pass <code>begin</code> a function to be triggered <span class="text-semibold">prior to the start</span> of the animation. As with <code>complete</code>, the begin callback is executed <code>once</code> per call, even if multiple elements are being animated. Further, if a call is looped, the begin callback only fires once — at the beginning of the first loop alternation.<br>
								...
								<p><a href="#" class="velocity-begin text-semibold"><i class="icon-play3 position-left"></i> Begin callback example &rarr;</a></p>
								<div class="row">
									<div class="col-md-4">
										<div class="panel panel-callout">
											<div class="panel-heading bg-blue">
...
$element.velocity({
	...
	begin: function() {
		alert('Begin callback example');
							...
							<!-- Complete callback -->
							<div class="content-group-lg">
								<h6 class="text-semibold">Complete callback</h6>
								<p class="content-group"><code>Complete</code> is the converse of the <code>begin</code> option. Pass the complete option a function to be triggered once the animation has finished. The function is executed <code>once</code> per call, even if multiple elements are being animated at once. Further, if a call is looped, the complete callback only fires once — at the end of the last loop alternation.<br>
								The callback is passed the entire raw DOM (not jQuery) element array as both its context and its first argument. To access these elements individually, you must iterate over the array using jQuery's <code>$.each()</code> or JavaScript's native <code>.forEach()</code>.</p>

								<p><a href="#" class="velocity-complete text-semibold"><i class="icon-play3 position-left"></i> Complete callback example &rarr;</a></p>
								<div class="row">
									<div class="col-md-4">
										<div class="panel panel-callout">
											<div class="panel-heading bg-blue">
...
$element.velocity({
	...
	complete: function() {
		alert('Complete callback example');
							...
							<!-- Progress callback -->
							<div class="content-group">
								<h6 class="text-semibold">Progress callback</h6>
								<p class="content-group">Pass the <code>progress</code> option a callback function to be repeatedly triggered througout the duration of the animation. The callback is passed the entire raw DOM (not jQuery) element array as both its context and its first argument. To access these elements individually, you must iterate over the array using jQuery's <code>$.each()</code> or JavaScript's native <code>.forEach()</code>. Further, it's passed <code>percentComplete</code> (decimal value), <code>timeRemaining</code> (in ms), and <code>timeStart</code> (Unix time).</p>

								<p><a href="#" class="velocity-progress text-semibold"><i class="icon-play3 position-left"></i> Complete callback example &rarr;</a> &nbsp; <span class="text-muted" id="percentComplete"></span> <span class="text-muted" id="timeRemaining"></span></p>
								<div class="row">
									<div class="col-md-4">
										<div class="panel panel-callout">
											<div class="panel-heading bg-blue">
