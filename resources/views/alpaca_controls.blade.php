							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="alpaca_controls.html">Controls</a></li>
									</ul>
								</li>
								<li>
			...
			<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Alpaca</span> - Controls</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="alpaca_controls.html">Alpaca</a></li>
				...
				<div class="content">					
					...
					<h6 class="content-group text-semibold">
						Checkbox inputs
						<small class="display-block">Checkbox inputs variations</small>
					</h6>
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Basic checkbox</h6>
									<div class="heading-elements">
										<ul class="icons-list">
								...
								<div class="panel-body">
									<p class="content-group">The following example demonstrates checkbox input type with both field label and right label. Validation is enabled by default and requires proper options added to checkbox configuration. Supports all available input-specific options.</p>
									<div id="alpaca-checkbox-label"></div>
									<a href="#alpaca-checkbox-label-source" data-toggle="collapse"><i class="icon-embed2 position-left"></i> Show source code &rarr;</a>
									<div class="collapse mt-10" id="alpaca-checkbox-label-source">
    ...
    "options": {
        ...
        "rightLabel": "Do you like Alpaca?"
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Display only mode</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">The following example demonstrates checkbox input type in display-only mode. Validation is enabled by default and requires proper options added to checkbox configuration. Supports all available input-specific options.</p>
									<div id="alpaca-checkbox-static"></div>
									<a href="#alpaca-checkbox-static-source" data-toggle="collapse"><i class="icon-embed2 position-left"></i> Show source code &rarr;</a>
									<div class="collapse mt-10" id="alpaca-checkbox-static-source">
        ...
        "label": "Registered?"
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Styled checkbox</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">The following example demonstrates checkbox input type with custom style added by Uniform plugin. Validation is enabled by default and requires proper options added to checkbox configuration. Supports all available input-specific options.</p>
									<div id="alpaca-checkbox-styled"></div>
									<a href="#alpaca-checkbox-styled-source" data-toggle="collapse"><i class="icon-embed2 position-left"></i> Show source code &rarr;</a>
									<div class="collapse mt-10" id="alpaca-checkbox-styled-source">
    ...
    "postRender": function(control) {
        $('.checkbox-styled').find('input[type=checkbox]').uniform();
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Disabled mode</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">The following example demonstrates styled checkbox input in disabled mode. Validation is enabled by default and requires proper options added to checkbox configuration. Supports all available input-specific options.</p>
									<div id="alpaca-checkbox-styled-disabled"></div>
									<a href="#alpaca-checkbox-styled-disabled-source" data-toggle="collapse"><i class="icon-embed2 position-left"></i> Show source code &rarr;</a>
									<div class="collapse mt-10" id="alpaca-checkbox-styled-disabled-source">
        ...
        $('.checkbox-styled-disabled').find('input[type=checkbox]').uniform();
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Switchery toggles</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">The following example demonstrates checkbox input type displayed as a toggle. Both Uniform and Switchery are custom additions, Alpaca doesn't support these components by default and requires custom configuraiton.</p>
									<div id="alpaca-switchery"></div>
									<a href="#alpaca-switchery-source" data-toggle="collapse"><i class="icon-embed2 position-left"></i> Show source code &rarr;</a>
									<div class="collapse mt-10" id="alpaca-switchery-source">
        ...
        $('.switchery-demo').find('.checkbox').addClass('checkbox-switchery');
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									<p class="content-group">The following example demonstrates checkbox input type displayed as a toggle, in disabled mode. Both Uniform and Switchery are custom additions, Alpaca doesn't support these components by default and requires custom configuraiton.</p>
									<div id="alpaca-switchery-disabled"></div>
									<a href="#alpaca-switchery-disabled-source" data-toggle="collapse"><i class="icon-embed2 position-left"></i> Show source code &rarr;</a>
									<div class="collapse mt-10" id="alpaca-switchery-disabled-source">
										<pre class="language-javascript"><code>// Switchery toggle
        ...
        $('.switchery-disabled-demo').find('.checkbox').addClass('checkbox-switchery');
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Basic checkbox list</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">The following example demonstrates checkbox list used for multiple values provided as an array. Validation is enabled by default and requires proper options added to checkbox configuration. Supports all available input-specific options.</p>
									<div id="alpaca-checkbox-list"></div>
									<a href="#alpaca-checkbox-list-source" data-toggle="collapse"><i class="icon-embed2 position-left"></i> Show source code &rarr;</a>
									<div class="collapse mt-10" id="alpaca-checkbox-list-source">
    ...
    "options": {
        ...
        "optionLabels": ["A Sandwich", "Potato Chips", "A Cookie", "Soft Drink"]
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Styled checkbox list</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">The following example demonstrates multiple checkbox list with custom style added by Uniform plugin. Validation is enabled by default and requires proper options added to checkbox configuration. Supports all available input-specific options.</p>
									<div id="alpaca-checkbox-list-styled"></div>
									<a href="#alpaca-checkbox-list-styled-source" data-toggle="collapse"><i class="icon-embed2 position-left"></i> Show source code &rarr;</a>
									<div class="collapse mt-10" id="alpaca-checkbox-list-styled-source">
...
$("#alpaca-checkbox-list-styled").alpaca({
    ...
    "postRender": function(control) {
        $('.checkbox-styled-list').find('input[type=checkbox]').uniform();
					...
					<h6 class="content-group text-semibold">
						Radio buttons
						<small class="display-block">Radio button variations</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Basic radios</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">The following example demonstrates <code>radio</code> button field with more than 3 options and custom option labels. Validation is enabled by default and requires proper options added to checkbox configuration. Supports all available input-specific options.</p>
									<div id="alpaca-radio-basic"></div>
									<a href="#alpaca-radio-basic-source" data-toggle="collapse"><i class="icon-embed2 position-left"></i> Show source code &rarr;</a>
									<div class="collapse mt-10" id="alpaca-radio-basic-source">
        ...
        "enum": ["red", "green", "blue", "white", "black"]
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									<p class="content-group">The following example demonstrates <code>radio</code> button field with set of options in disabled mode. Validation is enabled by default and requires proper options added to checkbox configuration. Supports all available input-specific options.</p>
									<div id="alpaca-radio-basic-disabled"></div>
									<a href="#alpaca-radio-basic-disabled-source" data-toggle="collapse"><i class="icon-embed2 position-left"></i> Show source code &rarr;</a>
									<div class="collapse mt-10" id="alpaca-radio-basic-disabled-source">
        ...
        "disabled": true
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Styled radios</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">The following example demonstrates radio button field with custom style added by Uniform plugin. Validation is enabled by default and requires proper options added to checkbox configuration. Supports all available input-specific options.</p>
									<div id="alpaca-radio-styled"></div>
									<a href="#alpaca-radio-styled-source" data-toggle="collapse"><i class="icon-embed2 position-left"></i> Show source code &rarr;</a>
									<div class="collapse mt-10" id="alpaca-radio-styled-source">
            ...
            radioClass: 'choice'
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									<p class="content-group">The following example demonstrates styled radio button in disabled mode. Validation is enabled by default and requires proper options added to checkbox configuration. Supports all available input-specific options.</p>
									<div id="alpaca-radio-styled-disabled"></div>
									<a href="#alpaca-radio-styled-disabled-source" data-toggle="collapse"><i class="icon-embed2 position-left"></i> Show source code &rarr;</a>
									<div class="collapse mt-10" id="alpaca-radio-styled-disabled-source">
										<pre class="language-javascript"><code>// Disabled mode
            ...
            radioClass: 'choice'
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Required radios</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">The following example demonstrates radio button with validation options and requirements. Validation engine automatically displays multiple notifications. To use, simply set <code>required</code> option to <code>true</code> in configuration.</p>
									<div id="alpaca-radio-required"></div>
									<a href="#alpaca-radio-required-source" data-toggle="collapse"><i class="icon-embed2 position-left"></i> Show source code &rarr;</a>
									<div class="collapse mt-10" id="alpaca-radio-required-source">
        ...
        "enum": ["Vanilla", "Chocolate", "Coffee"]
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									<p class="content-group">A radio field that uses the <code>removeDefaultNone</code> option to remove the option for the end user to select <code>None</code> from the list of available options. In addition, the <code>vertical</code> option is specified to inform the field to render vertically.</p>
									<div id="alpaca-radio-options"></div>
									<a href="#alpaca-radio-options-source" data-toggle="collapse"><i class="icon-embed2 position-left"></i> Show source code &rarr;</a>
									<div class="collapse mt-10" id="alpaca-radio-options-source">
    ...
    "options": {
        ...
        "vertical": true
					...
					<h6 class="content-group text-semibold">
						...
						<small class="display-block">Display tagged elements</small>
					</h6>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Tokenfield</h6>
									<div class="heading-elements">
										<ul class="icons-list">
					                		<li><a data-action="collapse"></a></li>
					                		<li><a data-action="reload"></a></li>
								...
								<div class="panel-body">
									<p class="content-group">The <code>token</code> field. This provides an implementation of the Bootstrap TokenField plugin on top of a text field to allow for autocomplete and typeahead tokens in a comma (or alternative separator) delimited string.</p>
									<div id="alpaca-tokenfield"></div>
									<a href="#alpaca-tokenfield-source" data-toggle="collapse"><i class="icon-embed2 position-left"></i> Show source code &rarr;</a>
									<div class="collapse mt-10" id="alpaca-tokenfield-source">
    ...
    "data": "marty,doc,george,biff"
						...
						<div class="col-md-6">
							<div class="panel panel-flat">
								...
								<div class="panel-body">
									<p class="content-group">Here is a token field that lets you pick character first names from the movie Back to the Future, displayed in display-only mode. Tokenfield also supports jQuery UI's <code>autocomplete</code> extension as seen in previous demo.</p>
									<div id="alpaca-tokenfield-static"></div>
									<a href="#alpaca-tokenfield-static-source" data-toggle="collapse"><i class="icon-embed2 position-left"></i> Show source code &rarr;</a>
									<div class="collapse mt-10" id="alpaca-tokenfield-static-source">
										<pre class="language-javascript"><code>// Display only mode
